...
# heatmap of key developmental genes in PCa v BPH
...
def check_gene_expression(df):
    ...
    ax.set_title('Expression levels of key genes in PCa v BPH', fontweight = 'bold')
    
check_gene_expression('CaPvBPH_total.csv')
